...
export const mockExecutions = [
  ...
  { id: 'EXE-20260901-00119', name: '캘린더 이벤트 생성', sourceType: 'AGENT_REQUEST' as ExecutionSourceType, user: 'admin', agent: 'General Work Assistant', workflow: null, status: 'FAILED' as ExecutionStatus, stepCount: 1, totalSteps: 2, duration: '–', startedAt: '2026-09-01 11:20', updatedAt: '2026-09-01 11:21', canRetry: true },
